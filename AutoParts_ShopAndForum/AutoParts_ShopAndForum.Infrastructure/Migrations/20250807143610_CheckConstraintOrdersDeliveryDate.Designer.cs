...
namespace AutoParts_ShopAndForum.Infrastructure.Migrations
{
    ...
    [Migration("20250807143610_CheckConstraintOrdersDeliveryDate")]
    partial class CheckConstraintOrdersDeliveryDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoParts_ShopAndForum.Infrastructure.Data.Models.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasCheckConstraint("CC_Orders_DeliveryDate", "([IsDelivered] = 0 OR [DateDelivered] IS NOT NULL)");
                        });
                });
